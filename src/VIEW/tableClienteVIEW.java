...
public class tableClienteVIEW extends javax.swing.JFrame {
	...
	pesquisarValoresCliente(Nome_tableClienteVIEW);
    ...
    private void pesquisarValoresCliente(String nome){
        try {
            ClienteDAO objClienteDAO = new ClienteDAO();
            ...
            ArrayList<ClienteDTO> lista = objClienteDAO.pesquisaEspecifica(nome);
